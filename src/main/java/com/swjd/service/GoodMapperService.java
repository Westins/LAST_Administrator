...
public interface GoodMapperService {
    //查询所有的商品
    ...
    //为goods表添加商品
    public int addGoods(@Param("gImg")String gImg,@Param("gName")String gName,@Param("gPrice")String gPrice,
                        @Param("gRebate")String gRebate,@Param("gType")String gType,@Param("gDetailsTest")String gDetailsTest,
                        @Param("gTime")String gTime);
    //修改特定的商品信息
