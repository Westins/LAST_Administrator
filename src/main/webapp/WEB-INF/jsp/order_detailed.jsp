...
<div class="Numbering">订单编号:<b>${order.oNum}</b></div></div>
 ...
 <!--收件人信息-->
    <div class="Receiver_style">
     ...
     <div class="Info_style clearfix">
        <div class="col-xs-4">  
         ...
         <div class="o_content">${order.aName}</div>
        </div>
        <div class="col-xs-4">  
         <label class="label_name" for="form-field-2"> 收件人电话： </label>
         <div class="o_content">${order.aPhone}</div>
        </div>
         <div class="col-xs-4">  
         ...
         <div class="o_content">${order.aAddress}</div>
        </div>
     </div>
    </div>
    <!--订单信息-->
    ...
    <div class="Info_style clearfix">
      ...
      <a href="#" class="img_link"><img src="${order.gImg}"  width="200" height="200"/></a>
      <span>
      <%--<a href="#" class="name_link">${order.gName}</a>--%>
      <%--<b>也称为姬娜果，饱满色艳，个头小</b>--%>
      <p>商品名：${order.gName}</p>
      <p>数量：${order.cNum}</p>
      <p>价格：<b class="price"><i>￥</i>${order.gPrice}</b></p>
     ...
     <div class="Info_style clearfix">
      <div class="col-xs-4">  
        ...
        <div class="col-xs-4">  
         ...
         <div class="o_content">${order.oTime}</div>
        </div>
        </div>
      <div class="Total_m_style"><span class="Total">总数：<b>${order.cNum}</b></span><span class="Total_price">总价：<b>${order.cNum*order.gPrice}</b>元</span></div>
    </div>
<div class="Button_operation">
				<button onclick="javascript:history.back(1)" class="btn btn-primary radius" type="submit"><i class="icon-save "></i>返回上一步</button>
