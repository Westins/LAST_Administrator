        ...
        <div class="widget-box side_content" >
            ...
            <div class="side_list">
                <div class="widget-header header-color-green2">
                    <h4 class="lighter smaller">产品类型</h4>
                </div>
    ...
    <div class="page_right_style">
        ...
        <form action="" method="post" class="form form-horizontal" id="form-article-add">
            <div class="clearfix cl">
                ...
                <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="gName" name="gName"></div>
            </div>
            <div class=" clearfix cl">
                <label class="form-label col-2">简略标题：</label>
                <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="gName1" name="gName1"></div>
            </div>
            <div class=" clearfix cl">
                ...
                <div class="Add_p_s">
                    ...
                    <%--<div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="gTpye" name="gTpye"></div>--%>
                    <div class="formControls col-2"><span class="select-box">
                    <select id="gType" name="gType" class="select">
                        <option value="">请选择</option>
                        <option value="1">宝宝洗护</option>
                        <option value="2">宝宝玩具</option>
                        <option value="3">童床</option>
                        <option value="4">尿裤湿巾</option>
                        <option value="5">奶粉</option>
                    </select>
                    </span></div>
                </div>
                <%--<div class="Add_p_s">--%>
                ...
                <div class="Add_p_s">
                    ...
                    <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="gPrice" name="gPrice" >元</div>
                </div>

                <div class="Add_p_s">
                    <label class="form-label col-2">折扣：</label>
                    <div class="formControls col-2"><span class="select-box">
				<select name="gRebate" id="gRebate" class="select">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10">
                    <textarea name="gDetailsTest" id="gDetailsTest" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
                        ...
                        function article_save_submit(){
                            ...
                            $.ajax({
                                ...
                                success:function (data) {
                                   // alert("data的值"+data);
                                    if (data==1) {
                                        layer.msg('添加成功!',{icon: 5,time:2000});
                                    } else if(data==0) {
                                    ...
                                    if ( file.getStatus() === 'invalid' ) {
                                        ...
                                        uploader.makeThumb( file, function( error, src ) {
                                            ...
                                            if( isSupportBase64 ) {
                                                ...
                                                $.ajax('${pageContext.request.contextPath}/Widget/webuploader/0.1.5/server/preview.php', {
                                                    method: 'POST',
                                                    data: src,
                                                    dataType:'json'
