            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <span class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>ADMIN[${sessionScope.user.lName}]	</span>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/home.do" class="iframeurl" title=""><i
                        class="icon-dashboard"></i><span class="menu-text"> 系统首页 </span></a></li>
                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/products_List.do" class="iframeurl" title=""><i
                        class="icon-desktop"></i><span class="menu-text"> 商品管理 </span></a></li>
                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/orderForm.do" class="iframeurl" title=""><i
                        class="icon-list"></i><span class="menu-text"> 订单管理 </span></a></li>
                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/user_list.do" class="iframeurl" title=""><i
                ...
                <%--<li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span--%>
                    ...
                    <%--<ul class="submenu">--%>
                            <%--<li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/products_List.do" title="产品列表"--%>
                ...
                <%--<li>--%>
                    ...
                    <%--<ul class="submenu">--%>
                        ...
                        <%--<li class="home"><a href="javascript:void(0)" name="orderForm.do" title="订单管理"--%>
                ...
                <%--<li>--%>
                    <%--<a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 用户管理 </span><b--%>
                            <%--class="arrow icon-angle-down"></b></a>--%>
                    <%--<ul class="submenu">--%>
                        <%--<li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/user_list.do" title="用户列表"--%>
        ...
        <div class="main-content">
            ...
            <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;" name="iframe" frameborder="0"
                    src="${pageContext.request.contextPath}/home.do"></iframe>
